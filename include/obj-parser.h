...
obj_mesh_t *obj_parser_parse(char *obj_path)
{
    ...
    mesh->vertices = (float*)malloc(mesh->vertices_size * sizeof(float));
    mesh->uvs = (float*)malloc(mesh->uvs_size * sizeof(float));
    mesh->normals = (float*)malloc(mesh->normals_size * sizeof(float));
    mesh->faces = (int*)malloc(mesh->faces_size * sizeof(int));
    ...
    mesh->triangles = (obj_triangle_t*)malloc(sizeof(obj_triangle_t) * mesh->triangles_count);
    int vertex_index;
    int uv_index;
    int normal_index;
